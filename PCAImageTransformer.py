...
def save_images_from_PCA(save_dir: str, encoder_file: str, pca_file: str, model, device, mean=0.0, std=1.0):
    if os.path.exists(pca_file):
        ...
        save_dir = os.path.join(save_dir, os.path.basename(pca_file).split('-')[0])
...
if __name__ == "__main__":
    ...
    for class_name in classes:
        save_images_from_PCA(save_dir="results/Decoded/Imitated_FromNoGen",
